...
def getparser():
    ...
    p.add('-t', '--total_timesteps', type=int, default=10_000_000, help='total timesteps per experiment')
    p.add('-e', '--env', type=str, default='MiniGrid-DoorMultiKey-6x6-v0', help='Core environment')
    ...
    p.add('--novelty_episode', default=2000, help='episode in which novelty is injected')
